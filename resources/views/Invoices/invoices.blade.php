...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
						<h4 class="content-title mb-0 my-auto">الفوتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            ...
                            @foreach( $invoice as $show )
                                ...
                                <tr>
                                    ...
                                    <td>{{ $show->product }}</td>
                                    <td>
                                        <a href="{{ url('InvoicesDetails') }}/{{ $show->id }}">{{ $show->Section->section_name }}</a>
                                    </td>
                                    <td>{{ $show->Discount }}</td>
                                    <td>{{ $show->Rate_VAT }}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                @can('تعديل الفاتورة')
                                                    <a class="dropdown-item" href="{{ url('edit_invoice') }}/{{ $show->id }}">
                                                    &nbsp;&nbsp;تعديل الفاتورة
                                                    </a>
                                                @endcan

                                                @can('حذف الفاتورة')
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $show->id }}"
                                                        data-toggle="modal" data-target="#delete_invoice"><i class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;حذفالفاتورة
                                                    </a>
                                                @endcan

                                                @can('تغير حالة الدفع')
                                                    <a class="dropdown-item" href="{{ URL::route('Status_show', [$show->id]) }}">
                                                ...
                                                @can('طباعةالفاتورة')
                                                    <a class="dropdown-item" href="Print_invoice/{{ $show->id }}">
